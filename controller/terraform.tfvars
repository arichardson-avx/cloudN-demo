...
keypair             = "cloudN-demo"
license_type        = "meteredplatinum" # Valid values are "meteredplatinum" and "BYOL"
...
customer_license_id = ""                # Provide license if BYOL selected
name_prefix         = ""                # Use it if there is already a controller deployed in the AWS account
